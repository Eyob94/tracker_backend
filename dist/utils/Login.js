    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                if (verified) {
                    return [2 /*return*/, { success: true, user: user, error: null }];
                }
                return [2 /*return*/, { success: false, user: null, error: "password not correct" }];
            case 3: return [2 /*return*/, { success: false, user: null, error: "user not found" }];
        }
    });
}); };
