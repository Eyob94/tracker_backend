    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _b.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, lib_1["default"].user.create({
                            data: {
                                email: email,
                                password: hash
                            }
                ...
                case 3:
                    user = _b.sent();
                    return [2 /*return*/, { user: user, success: true, error: null }];
                case 4:
                    err_1 = _b.sent();
                    if ((err_1.code = "P2002")) {
                        return [2 /*return*/, { user: null, success: false, error: "email already exists" }];
                    }
                    return [2 /*return*/, { user: null, success: false, error: err_1.message }];
